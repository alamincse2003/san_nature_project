                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="title" class="form-control" value="{{ old('title',isset($project->title)?ucwords($project->title):null) }}" required  placeholder="Project Title">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <input type="text" name="short_title" class="form-control" value="{{ old('sub_title',isset($project->short_title)?ucwords($project->short_title):null) }}"  placeholder="Project Sub Title">
                                                    <div class="form-control-position">
                                                        <i class="bx bx-user"></i>
                                                    </div>
                                                    @error('short_title')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <textarea name="description1"  class="form-control char-textarea" id="address-counter" rows="10" placeholder="Write details">{{ old('description1',isset($project->description1)?ucwords($project->description1):null) }}</textarea>
                                                    <div class="form-control-position">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls position-relative has-icon-left">
                                                    <textarea name="description2"  class="form-control char-textarea" id="address-counter" rows="10" placeholder="Write details">{{ old('description2',isset($project->description2)?ucwords($project->description2):null) }}</textarea>
                                                    <div class="form-control-position">
                                                        <i class="bx bx-info-circle"></i>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="select3-theme form-control" name="project_type">
                                                    @if($project->project_type)
                                                        <option selected>{{ ucwords($project->project_type) }}</option>
                                                    @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if($project->banner_photo != null)
                                                    <img src="{{ asset($project->banner_photo) }}" class="user-profile-image rounded" alt="slider image" style="height: 150px !important; width: 250px !important;" >
                                                @else
                                                    <div class="badge badge-pill badge-light-danger mr-1"> No Banner Photo Found.</div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if($project->photo != null)
                                                    <img src="{{ asset($project->photo) }}" class="user-profile-image rounded" alt="slider image" style="height: 150px !important; width: 250px !important;" >
                                                @else
                                                    <div class="badge badge-pill badge-light-danger mr-1"> No Project Photo Found.</div>
                                                @endif
                                            </div>
                                        </div>
                                        {{--                                        <div class="col-md-6">--}}
